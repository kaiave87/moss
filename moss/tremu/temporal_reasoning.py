"""
TReMu-style temporal reasoning for conversational memory systems.
...
Proven yield: 29.8% -> 77.7% on temporal category (LoCoMo benchmark).
...
def temporal_answer(
    ...
    *,
    ...
    if code2 and code2 != code:
        result2 = execute_temporal_code(code2, timeline)
